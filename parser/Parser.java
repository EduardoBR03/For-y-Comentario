...
public class Parser {
   ...
   Stmt stmt() throws IOException {
      Expr x,y,z,m,n,o,p,q;  Stmt s, s1, s2;
      ...
      case Tag.BREAK:
         ...
         return new Break();
      case Tag.COMENTARIO:
         comentario comennode = new comentario();
         savedStmt = Stmt.Enclosing; Stmt.Enclosing = comennode;
         term();
         Stmt.Enclosing = savedStmt;  // reset Stmt.Enclosing
         return comennode;
      ...
      case Tag.FOR:
         ...
         match(Tag.FOR); match('(');m=bool();match('=');n=bool();match(';');o=bool();match(';');p=bool();match('=');q=bool();match(')');
         s1 = stmt();
         fornode.init(m,n,o,p,q,s1);
         Stmt.Enclosing = savedStmt;  // reset Stmt.Enclosing
         return fornode;
      case '{':
         return block();
